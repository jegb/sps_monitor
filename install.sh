...
pip install --break-system-packages adafruit-blinka adafruit-circuitpython-dht paho-mqtt RPi.GPIO flask adafruit-circuitpython-busio adafruit-circuitpython-sht31d
